...
public class ClienteService {
    ...
    public Cliente atualizarCliente(Long id, Cliente clienteAtualizar) {
        return clienteRepo.findById(id)
                ...
                .orElseThrow(() -> new RuntimeException("Cliente não encontrao com id " + id));
    }
    ...
    public Pedido atualizarPedido(Long id, Pedido pedidoAtualizar) {
        return pedidoRepo.findById(id)
                .map(pedido -> {
                    pedido.setDescricao(pedidoAtualizar.getDescricao());
                    pedido.setCliente(pedidoAtualizar.getCliente());
                    return pedidoRepo.save(pedido);
                })
